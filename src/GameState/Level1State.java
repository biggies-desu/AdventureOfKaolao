...
public class Level1State extends GameState{
    ...
    public void init(){
        ...
        tileMap.loadMap("/Resource/level1.map");
        tileMap.setPosition(0, 0);
        tileMap.setTween(1);
        
        bg = new Background("/Resource/bg_1.png", 0.3);
    ...
    public void draw(Graphics2D g) {
        ...
        if((player.getX()>=3690 && player.getY()<=110))
       {
    ...
    private void setenemiespos() {
        ...
        e5.setPosition(300, 150);
        enemies.add(e5);
        
        Enemy2 e6 = new Enemy2(tileMap);
        e6.setPosition(1540, 395);
        enemies.add(e6);
